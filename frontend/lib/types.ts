...
export type HeatmapItem = { symbol: string; name: string; sector: string; industry: string; price: number; change_pct: number; market_cap_weight: number; volume: number | null; dollar_volume: number | null; relative_volume: number | null; trading_date: string | null };
