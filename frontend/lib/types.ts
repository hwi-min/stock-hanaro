...
export type StockDetail = { symbol: string; name: string; market: "kr" | "us"; exchange: string; sector: string; industry: string; currency: "KRW" | "USD"; price: number; change: number; change_pct: number; volume: number | null; market_cap: number | null; per: number | null; pbr: number | null; foreign_ownership_pct: number | null; high_52w: number | null; low_52w: number | null; as_of: string; session_date: string | null; basis: "realtime" | "snapshot" | "close"; interval: StockInterval; chart: ChartPoint[] };
