...
export type StockDetail = { symbol: string; name: string; market: "kr" | "us"; exchange: string; sector: string; industry: string; currency: "KRW" | "USD"; price: number; change: number; change_pct: number; volume: number | null; as_of: string; session_date: string | null; basis: "realtime" | "snapshot" | "close"; interval: "daily" | "minute"; chart: ChartPoint[] };
